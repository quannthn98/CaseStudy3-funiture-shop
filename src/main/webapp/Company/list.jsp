        ...
        <div class="col-10">
            <div class="card">
                ...
                <c:forEach items="${companies}" var="company">
                    <div class="modal fade" id="staticBackdrop${company.id}" data-bs-backdrop="static" data-bs-keyboard="false"
                         tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel">Company Detail</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <button type="button" class="btn btn-outline-primary float-end">
                                <a href="/Company?action=create" style="text-decoration: none">
                                    Add New
                                </a>
                            </button>
                        </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${companies}" var="company">
                            <tr>
                                ...
                                <td>${company.note}</td>
                                <td>${company.status?"hiện":"ẩn"}</td>
                                <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop${company.id}">Detail</button></td>
                                <td><button type="button" class="btn btn-success btn-sm">
                                    <a style=" text-decoration: none;color: white" href="/Company?action=detail&id=${company.id}">Edit</a>
                                </button></td>
                                <td><button type="button" class="btn btn-danger btn-sm">
                                    <a style=" text-decoration: none;color: white" href="/Company?action=delete&id=${company.id}">Delete</a>
                                </button></td>
                            </tr>
                        </c:forEach>
                    </table>
