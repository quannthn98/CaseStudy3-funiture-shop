                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="name"  value="${news.title}" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Address</label>
                            <input type="text" name="subtitle" class="form-control"  value="${news.subtitle}" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="id_Customer" class="form-control" value="${news.id_Customer}" readonly>
                        </div>
