                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <button type="button" class="btn btn-outline-primary float-end">
                                <a href="/New?action=create" style="text-decoration: none">
                                    Add New
                                </a>
                            </button>
                        </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${newss}" var="news">
                            <tr>
                                ...
                                <td>${news.status?"hiện":"ẩn"}</td>
                                <td>${news.id_Customer}</td>
                                <td><button type="button" class="btn btn-success btn-sm">
                                    <a style=" text-decoration: none;color: white" href="/New?action=detail&id=${news.id}">Detail</a>
                                </button></td>
                                <td><button type="button" class="btn btn-danger btn-sm">
                                    <a style=" text-decoration: none;color: white" href="/New?action=delete&id=${news.id}">Delete</a>
                                </button></td>
                            </tr>
                        </c:forEach>
                    </table>
