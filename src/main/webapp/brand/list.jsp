            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="/brand?action=create-brand" class="btn btn-outline-primary float-end"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="color: white" class="btn btn-primary btn-sm"
                                       href="/brand?action=edit-brand&id=${brandList.id}">Edit</a>
                                    <a style="color: white;" class="btn btn-danger btn-sm"
                                       href="/brand?action=delete-brand&id=${brandList.id}">Delete</a>
