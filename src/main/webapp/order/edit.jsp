            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <%--                            <input type="text" name="name" class="form-control" id="name" value="${order.consignee}">--%>
                        <%--                        </div>--%>
                        <%--                        <div class="mb-3">--%>
                        ...
                        <%--                            <input type="text" name="address" class="form-control" id="address" value="${order.addressOrder}" >--%>
                        <%--                        </div>--%>
                        <div class="mb-3">
<%--                            <label for="note" class="form-label">Note</label>--%>
                            <h5>Note</h5>
<%--                            <input rows="10" type="text" name="note" class="form-control" id="note" value="${order.note}">--%>
                            <textarea name="note" id="note" style="width: 100%" rows="5">${order.note}</textarea>
                        </div>
                        <%--                        <div class="mb-3">--%>
                        <%--                            <label for="saleOff" class="form-label">Sale Off</label>--%>
                        <%--                            <input type="text" name="saleOff" class="form-control" id="saleOff" value="${saleOff}">--%>
                        <%--                        </div>--%>
<%--                        <label for="status" class="form-label">Set status</label>--%>
                            <h5>Update Status</h5>
                        <select id="status" style="width: 200px" class="form-select" aria-label="Default select example"
                                name="status">
