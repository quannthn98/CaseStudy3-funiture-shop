...
<section class="main-cart-page main-container col1-layout">
  <div class="main container hidden-xs">
    ...
    <div class="col-main cart_desktop_page cart-page"><div class="cart page_cart hidden-xs"><form action="/cart" method="post" novalidate="" class="margin-bottom-0"><div class="bg-scroll"><div class="cart-thead"><div style="width: 17%">Ảnh sản phẩm</div><div style="width: 33%"><span class="nobr">Tên sản phẩm</span></div><div style="width: 15%" class="a-center"><span class="nobr">Đơn giá</span></div><div style="width: 14%" class="a-center">Số lượng</div><div style="width: 15%" class="a-center">Thành tiền</div><div style="width: 6%">Xoá</div></div><div class="cart-tbody"><div class="item-cart productid-14992946"><div style="width: 17%" class="image"><a class="product-image" title="Sofa bộ Italia - Canova - Trắng" href="/sofa-da-ma-ntx1824"><img width="75" height="auto" alt="Sofa bộ Italia - Canova - Trắng" src="//bizweb.dktcdn.net/thumb/small/100/284/162/products/10.jpg"></a></div><div style="width: 33%" class="a-center prd_name"><h2 class="product-name"> <a class="text2line" href="/sofa-da-ma-ntx1824">Sofa bộ Italia - Canova</a> </h2><span class="variant-title">Trắng</span></div><div style="width: 15%" class="a-center"><span class="item-price"> <span class="price">40.000.000₫</span></span></div><div style="width: 14%" class="a-center"><div class="input_qty_pr"><input class="variantID" type="hidden" name="variantId" value="14992946"><button onclick="var result = document.getElementById('qtyItem14992946'); var qtyItem14992946 = result.value; if( !isNaN( qtyItem14992946 ) &amp;&amp; qtyItem14992946 > 1 ) result.value--;return false;" disabled="" class="reduced_pop items-count btn-minus" type="button">–</button><input type="text" maxlength="12" min="0" class="input-text number-sidebar input_pop input_pop qtyItem14992946" id="qtyItem14992946" name="Lines" size="4" value="1"><button onclick="var result = document.getElementById('qtyItem14992946'); var qtyItem14992946 = result.value; if( !isNaN( qtyItem14992946 )) result.value++;return false;" class="increase_pop items-count btn-plus" type="button">+</button></div></div><div style="width: 15%" class="a-center"><span class="cart-price"> <span class="price">40.000.000₫</span> </span></div><div style="width: 6%"><a class="button remove-item remove-item-cart" title="Xóa" href="javascript:;" data-id="14992946"><span><i class="fa fa-times" aria-hidden="true"></i></span></a></div></div></div></div></form><div class="cart-collaterals cart_submit row"><div class="totals col-sm-12 col-md-12 col-xs-12"><div class="totals"><div class="inner"><table class="table shopping-cart-table-total margin-bottom-0" id="shopping-cart-totals-table"><colgroup><col><col></colgroup><tfoot><tr><td colspan="20" class="a-right"><span>Tổng tiền thanh toán:</span></td><td class="a-right"><strong><span class="totals_price price">40.000.000₫</span></strong></td></tr></tfoot></table><ul class="checkout"><li class="clearfix f-right"><button class="btn btn-white f-left" title="Tiếp tục mua hàng" type="button" onclick="window.location.href='/collections/all'"><span>Tiếp tục mua hàng</span></button><button class="btn btn-primary button btn-proceed-checkout f-right" title="Thực hiện thanh toán" type="button" onclick="window.location.href='/checkout'"><span>Thực hiện thanh toán</span></button></li></ul></div></div></div></div></div></div>
  </div>
