...
<head>
    ...
    <script src="js/common.js?4" type="text/javascript"></script>
                ...
                <div class="col-md-6 col-sm-6 d-list col-xs-12 a-right topbar_right">
                    <div class="list-inline a-center f-right">
                        <ul>
                            ...
                            <li>
                                <a href="register.jsp" title="Đăng ký" class="account_a">
                                    <span>Đăng ký</span>
                                </a>
                            </li>
                            <li>
                ...
                <div id="login">
                    ...
                    <div class="social-login text-left margin-top-15 margin-bottom-0">
                        ...
                        <a href="javascript:void(0)" class="social-login--facebook" onclick="loginFacebook()"><img
                                width="129px" height="37px" alt="facebook-login-button" src="image/fb-btn.svg"></a>
                        <a href="javascript:void(0)" class="social-login--google" onclick="loginGoogle()"><img
                                width="129px" height="37px" alt="google-login-button" src="image/gp-btn.svg"></a>
                    </div>
